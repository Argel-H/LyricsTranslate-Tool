export const en = {
  ...
  "setup.importLyrics": "Import Lyrics (.lrc/.srt)",
  "setup.pasteLyrics": "Paste LRC or SRT content here...",
  "setup.chooseFile": "Choose File",
  "setup.clearLyrics": "Clear",
  "setup.lyricsValid": "Valid {format} · {count} lines · {sync}",
  "setup.lyricsInvalid": "Invalid: {error}",
  "setup.lyricsSynced": "synced",
  "setup.lyricsUnsynced": "plain text",
  ...
  "setup.lookupSynced": "synced",
  "setup.lookupPlainText": "plain text",
  ...
  "editor.commentPlaceholder": "Add a comment…",
  "editor.commentClear": "Clear comment",
  "editor.commentBold": "Bold",
  "editor.commentItalic": "Italic",
  "editor.commentUnderline": "Underline",
  "editor.commentHighlight": "Highlight",
