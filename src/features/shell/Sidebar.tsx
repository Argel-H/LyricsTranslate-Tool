...
export function Sidebar({ activePage, bgColor = "bg-surface-container-lowest", className, onOpenSettings, onOpenAbout }: SidebarProps) {
  ...
  return (
    <nav
      className={cn(
        "hidden lg:flex flex-col h-screen fixed left-0 top-0 w-20 z-10 py-lg",
        bgColor,
        className
      )}
    >
